...
public class HardLevelThree extends AbstractHardLevel {
    /**
    ...
    public GameSession create(Configuration config) {
        return new HardLevelThree.HardGameThree(config);
    }
     ...
     */
    private class HardGameThree extends AbstractGameSession {

        /**
         * Construct a {@link HardGameThree} instance.
         *
         * @param config The game configuration to use.
         */
        public HardGameThree(Configuration config) {
            super(config, 6, 6);
